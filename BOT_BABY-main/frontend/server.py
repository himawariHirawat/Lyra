...
def process_query():
    ...
    # You can now process the query using Python code
    result = process_query_function(query)
    printl(str(result))
    body(result)
    query = result
    return result

def process_query_function(query):
    # Add your Python code to process the query here
...
# READING CSV FILES
queries = pd.read_csv("https://raw.githubusercontent.com/himawariHirawat/Lyra/main/BOT_BABY-main/temp.csv")
con = pd.read_csv("https://raw.githubusercontent.com/himawariHirawat/Lyra/main/BOT_BABY-main/Conversation.csv")
songs = pd.read_csv("https://raw.githubusercontent.com/himawariHirawat/Lyra/main/BOT_BABY-main/spotify_songs.csv")
cuss = pd.read_csv("https://raw.githubusercontent.com/himawariHirawat/Lyra/main/BOT_BABY-main/cuss.csv")
